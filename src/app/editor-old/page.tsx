  ...
  const ToolButton = ({
    ...
    return (
      <button
        ...
        className={`px-2 sm:px-3 py-2 rounded-lg text-sm font-medium transition-all flex flex-col items-center gap-1 min-w-[2.5rem] sm:min-w-[3.5rem]
        ${
          selectedTool === tool
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="bg-white border-b border-gray-200 px-4 py-2">
          <div className="max-w-4xl mx-auto flex items-center justify-center gap-4 flex-wrap">
            {/* Panel toggles - shown on mobile, or always for quick access */}
        ...
        {/* Music Rules Sidebar */}
        <MusicRulesSidebar isOpen={showRulesSidebar} />
        ...
        {/* Piano Drawer - only render when open for performance */}
        {showPiano && (
          <PianoDrawer
