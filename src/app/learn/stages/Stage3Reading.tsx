    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      {step >= 1 && (
        <ConceptCard title="Bar Lines & Measures" emoji="📏">
          ...
          <p className="text-sm text-gray-600">
            Think of measures like sentences in a book — they help organize the
            music into manageable chunks.
          </p>
        </ConceptCard>
      )}
      ...
      {step >= 2 && (
        <ConceptCard title="Time Signature" emoji="4️⃣">
          <p className="mb-4">
            ...
            most common is <strong>4/4</strong> (called &quot;four-four&quot;).
          </p>
      ...
      {step >= 3 && (
        <ConceptCard title="Using Playback" emoji="▶️" variant="interactive">
          <p className="mb-4">
            The editor has a <strong>Play button</strong> that plays your music
            for you! A moving line (the &quot;playhead&quot;) shows you which
            note is playing.
          </p>
          ...
          <p className="text-sm text-gray-600">
            <strong>Tip:</strong> Use the tempo control to speed up or slow down
            playback. Start slow when learning a new piece!
          </p>
        </ConceptCard>
      )}
